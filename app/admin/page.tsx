  ...
  return (
    <div className="group relative overflow-hidden rounded-xl border border-zinc-800/60 bg-zinc-900/30 p-5 transition-all duration-200 hover:border-zinc-700 hover:bg-zinc-900/50">
      ...
      <div className="relative flex items-start justify-between gap-2">
        ...
        <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg border border-zinc-800 bg-zinc-950 text-zinc-500 transition-colors duration-200 group-hover:border-zinc-700 group-hover:text-zinc-300">
